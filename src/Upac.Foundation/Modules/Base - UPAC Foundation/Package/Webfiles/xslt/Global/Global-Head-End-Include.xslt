...
<xsl:stylesheet
  ...
  exclude-result-prefixes="msxml umbraco.library Exslt.ExsltCommon Exslt.ExsltDatesAndTimes Exslt.ExsltMath Exslt.ExsltRegularExpressions Exslt.ExsltStrings Exslt.ExsltSets upac ">
	...
	<xsl:template match="/">
		<xsl:value-of select="$currentPage/ancestor-or-self::*[@level=1]/ConfigurationContainer/ConfigurationHtmlIncludes/globalHeadEndInclude" disable-output-escaping="yes"/>
	</xsl:template>
